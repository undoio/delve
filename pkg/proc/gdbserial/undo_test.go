...
func TestUndoRestartAfterExit(t *testing.T) {
	...
	withUndoRecording("testnextprog", t, func(p *gdbserial.Process, fixture protest.Fixture) {
...
func TestUndoReverseBreakpointCounts(t *testing.T) {
	protest.AllowRecording(t)
	withUndoRecording("bpcountstest", t, func(p *gdbserial.Process, fixture protest.Fixture) {
...
func TestUndoCheckpoints(t *testing.T) {
	protest.AllowRecording(t)
	withUndoRecording("continuetestprog", t, func(p *gdbserial.Process, fixture protest.Fixture) {
