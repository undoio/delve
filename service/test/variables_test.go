...
func TestCallFunction(t *testing.T) {
	...
	var testcases = []testCaseCallFunction{
		...
		// UNDO: {`fn2clos(12)`, []string{`:string:"2 + 6 + 12 = 20"`}, nil},
		...
		// UNDO: {`pa2 = getAStructPtr(8); pa2`, []string{`pa2:*main.astruct:*main.astruct {X: 8}`}, nil},
	...
	var testcases112 = []testCaseCallFunction{
		...
		// UNDO: {`str = "a new string"; str`, []string{`str:string:"a new string"`}, nil},
