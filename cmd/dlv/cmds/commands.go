...
Currently supports linux/amd64 core files and windows/amd64 minidumps.`,
	...
	if rrAvailable || undoAvailable {
		replayCommand := &cobra.Command{
			Use:   "replay [trace directory or file]",
			Short: "Replays a rr or UndoDB trace.",
			Long: `Replays a rr or UndoDB trace.

The replay command will open a trace generated by Mozilla rr or UndoDB.
Either Mozilla rr (https://github.com/mozilla/rr) or UndoDB (https://undo.io) must be installed.
